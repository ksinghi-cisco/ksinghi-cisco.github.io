...
{% include important.html content="Please expand the Lab Scenario chosen by you during registration and make note of the lab tasks that have been pre-configured and the tasks that need to be configured. All lab sections are viewable for reference. If a SWAT contact is assisting with these labs, please check with him/her for the lab tasks which need to be configured by you." %}
